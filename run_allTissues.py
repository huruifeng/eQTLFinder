...
def plotResults(tissue, result_folder):
    # ===================================================================
    ...
    plt.savefig(result_folder+"/AUROC.pdf")
    ...
    plt.legend(loc="best", fontsize=6)
    plt.savefig(result_folder+"/P-R.pdf")
...
if __name__ == '__main__':
    ...
    for tissue_i in os.listdir(matrix_folder):
        tissue =  tissue_i[:-11]
        plotResults(tissue, result_folder)

    print('[INFO] Draw plots, Done !')
