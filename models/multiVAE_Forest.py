...
def multiVAE_Forest(dataset_X,dataset_Y):
    ...
    x = Input(shape=(original_dim,), name="mVAE_Forest_Roadmap_input")
    h = Dense(intermediate_dim, activation='relu', name="mVAE_Forest_Roadmap_hidden")(x)
    z_mean = Dense(latent_dim, name="mVAE_Forest_Roadmap_zmean")(h)
    z_log_sigma = Dense(latent_dim, name="mVAE_Forest_Roadmap_zlogsigma")(h)
    ...
    z = Lambda(sampling, output_shape=(latent_dim,), name="mVAE_Forest_Roadmap_z")([z_mean, z_log_sigma])

    h_decoded = Dense(intermediate_dim, activation='relu', name="mVAE_Forest_Roadmap_hdecode")(z)
    x_decoded_mean = Dense(original_dim, activation='sigmoid', name="mVAE_Forest_Roadmap_decodemean")(h_decoded)
    ...
    x = Input(shape=(original_dim,), name="mVAE_Forest_TF_input")
    h = Dense(intermediate_dim, activation='relu', name="mVAE_Forest_TF_hidden")(x)
    z_mean = Dense(latent_dim, name="mVAE_Forest_TF_zmean")(h)
    z_log_sigma = Dense(latent_dim, name="mVAE_Forest_TF_zlogsigma")(h)

    z = Lambda(sampling, output_shape=(latent_dim,), name="mVAE_Forest_TF_z")([z_mean, z_log_sigma])

    h_decoded = Dense(intermediate_dim, activation='relu', name="mVAE_Forest_TF_hdecode")(z)
    x_decoded_mean = Dense(original_dim, activation='sigmoid', name="mVAE_Forest_TF_decodemean")(h_decoded)
    ...
    x = Input(shape=(original_dim,), name="mVAE_Forest_DMAacc_Input")
    h = Dense(intermediate_dim, activation='relu', name="mVAE_Forest_DMAacc_hidden")(x)
    z_mean = Dense(latent_dim, name="mVAE_Forest_DMAacc_zmean")(h)
    z_log_sigma = Dense(latent_dim, name="mVAE_Forest_DMAacc_zlogsigma")(h)

    z = Lambda(sampling, output_shape=(latent_dim,), name="mVAE_Forest_DMAacc_z")([z_mean, z_log_sigma])

    h_decoded = Dense(intermediate_dim, activation='relu', name="mVAE_Forest_DMAacc_hdecode")(z)
    x_decoded_mean = Dense(original_dim, activation='sigmoid', name="mVAE_Forest_DMAacc_decodemean")(h_decoded)
