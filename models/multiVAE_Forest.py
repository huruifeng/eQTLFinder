...
def multiVAE_Forest(dataset_X,dataset_Y):
    ...
    x = Input(shape=(original_dim,), name="mVAE_Forest_DNAacc_Input")
    h = Dense(intermediate_dim, activation='relu', name="mVAE_Forest_DNAacc_hidden")(x)
    z_mean = Dense(latent_dim, name="mVAE_Forest_DNAacc_zmean")(h)
    z_log_sigma = Dense(latent_dim, name="mVAE_Forest_DNAacc_zlogsigma")(h)

    z = Lambda(sampling, output_shape=(latent_dim,), name="mVAE_Forest_DNAacc_z")([z_mean, z_log_sigma])

    h_decoded = Dense(intermediate_dim, activation='relu', name="mVAE_Forest_DNAacc_hdecode")(z)
    x_decoded_mean = Dense(original_dim, activation='sigmoid', name="mVAE_Forest_DNAacc_decodemean")(h_decoded)
